...
audio, sample_rate = read_wave('C:/Users/ANANTH/Desktop/input_test.wav')
vad = webrtcvad.Vad(2)
...
os.getcwd()
os.chdir("C:/Users/ANANTH/Desktop/test_file_path")
os.getcwd()

"""
y = librosa.load(test_file_path)
sr=librosa.load(test_file_path)
print(np.shape(y))
